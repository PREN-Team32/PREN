...
Ein Motor richtet die Abwurfeinheit auf das Ziel aus. Der ganze Aufbau des Ballwurfmechanismus ist möglichst einfach gehalten. 
...
Die Ausrichtung des Abwurfmechanismus erfolgt durch einen Motor, welcher in der drehenden Abwurfeinheit angebracht ist. 
...
\begin{table}[h!]
	...
	\end{threeparttable} 
\end{table}
\parindent 0pt In den folgenden Abschnitten wird nach dem zeitlichen Ablauf des Balles, die einzelnen Komponenten des Ballwerfers näher beschrieben. 