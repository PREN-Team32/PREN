...
\begin{figure}[h!]
    ...
    \draw  (0,11pt) -- (6, 11pt); \draw (0,-11pt) -- (6,-11pt); %die beiden Förderbänder-Striche
    ...
    \draw (5,11pt) -- (5, 25pt);\draw (5.7,11pt) -- (5.7, 25pt);\draw (5,25pt) -- (5.7, 25pt);\node  at (5.35,18pt) {$m_B$};    
    \draw (4,11pt) -- (4, 25pt);\draw (4.7,11pt) -- (4.7, 25pt);\draw (4,25pt) -- (4.7, 25pt);\node  at (4.35,18pt) {$m_B$};        
    \draw (3,11pt) -- (3, 25pt);\draw (3.7,11pt) -- (3.7, 25pt);\draw (3,25pt) -- (3.7, 25pt);\node  at (3.35,18pt) {$m_B$};    
    \draw (2,11pt) -- (2, 25pt);\draw (2.7,11pt) -- (2.7, 25pt);\draw (2,25pt) -- (2.7, 25pt);\node  at (2.35,18pt) {$m_B$};    
    \draw (1,11pt) -- (1, 25pt);\draw (1.7,11pt) -- (1.7, 25pt);\draw (1,25pt) -- (1.7, 25pt);\node  at (1.35,18pt) {$m_B$};
